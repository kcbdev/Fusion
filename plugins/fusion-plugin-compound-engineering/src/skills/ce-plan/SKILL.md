...
FN-7147 routes HTML plans through ce-doc-review report-only mode so users get findings without risking markdown mutation mechanics corrupting the HTML artifact.
-->
