...
FN-7147 routes HTML plans through ce-doc-review so users get findings without risking markdown mutation mechanics corrupting the HTML artifact. FN-7149 permits only DOM-safe helper mutations and preserves report-only fallback on any safety refusal.
-->
